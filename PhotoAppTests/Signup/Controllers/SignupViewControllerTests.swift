...
class SignupViewControllerTests: XCTestCase {
    ...
    func testViewController_WhenSignupButtonTapped_InvokesSignupProcess() {
        ...
        // Assert
        XCTAssertTrue(mockSignupPresenter.processUserSignupCalled, "processUserSignup() method was not called on a Presenter object when the signup button was tapped in a SignupViewController")
    }
}
